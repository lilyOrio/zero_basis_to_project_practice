...
public class InterpolatorActivity extends AppCompatActivity implements Animator.AnimatorListener {
    ...
    public void onAnimationEnd(Animator animator) {
        if (animator.equals(animBounce)) { // 震荡动画
            // 构造一个在文字大小上变化的属性动画
    ...
    class InterpolatorSelectedListener implements AdapterView.OnItemSelectedListener {

        @Override
        public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
            showInterpolator(i); // 根据插值器类型展示属性动画
        }
